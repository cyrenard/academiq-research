(function(root, factory){
  ...
  function buildTOCHTML(editorRoot, headings, deps){
    deps = deps || {};
    var pageContentHeight = deps.pageContentHeight || 864;
    ...
    Array.from(headings || []).forEach(function(heading){
      ...
      html += '<p class="ni toc-entry" style="text-indent:0;padding-left:' + indent + 'px;cursor:pointer;margin:0;display:flex;gap:8px;align-items:flex-end;color:#000;background:transparent;border:none;box-shadow:none;font-family:&quot;Times New Roman&quot;,Times,serif;font-size:12pt;line-height:2;text-decoration:none;" data-toc-idx="' + realIdx + '" data-target-id="' + heading.id + '"><span class="toc-text" style="white-space:nowrap;">' + text + '</span><span style="flex:1;border-bottom:1px dotted #000;transform:translateY(-4px);"></span><span class="toc-page">' + pageNum + '</span></p>';
      realIdx++;
    });
    html += '</div>';
    return html;
